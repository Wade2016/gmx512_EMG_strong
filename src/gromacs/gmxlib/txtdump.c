...
static void pr_pulse(FILE *fp, int indent, const char *title, t_efield *cos,
                      gmx_bool bMDPformat)
{
    int j;
                 ...
                 gmx_bool bMDPformat)
{
    ...
    if (available(fp, ir, indent, title))
    {
        ...
        pr_pulse(fp, indent, "E-xt", &(ir->et[XX]), bMDPformat);
        pr_cosine(fp, indent, "E-y", &(ir->ex[YY]), bMDPformat);
        pr_pulse(fp, indent, "E-yt", &(ir->et[YY]), bMDPformat);
        pr_cosine(fp, indent, "E-z", &(ir->ex[ZZ]), bMDPformat);
        pr_pulse(fp, indent, "E-zt", &(ir->et[ZZ]), bMDPformat);
